...
<body>
    <section id="home" class="homeContainer">
        <div class="welcomeContainer">
            ...
            <?php 
                $fetchDetails = mysqli_query($conn, "SELECT * FROM user");
            ?>
            ...
            <?php 
                if(isset($_GET['edit']))
                {
                    ...
                    <form class="editForm" action="../pages/edit-validate.php" method="GET">
                        ...
                        <input type="text" name="dateCreatedEdit" value="<?php echo $toEditData['date_created']; ?>">
                        <input type="text" name="lastLoggedEdit" value="<?php echo $toEditData['date_lastLogged']; ?>">
