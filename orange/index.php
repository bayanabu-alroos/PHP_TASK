...
$phones = [
    [ 
     ...
     'img_url' =>'https://mobizil.com/wp-content/uploads/2022/03/Samsung-Galaxy-A13.jpg ',
    'rate' => '5',
    'brand' => 'Samsung',
    'price' => 'JOD 200.00',
    'is_out_of_stock' => '1'
    ...
    [ 
     ...
     'img_url' =>' https://specificationsplus.com/wp-content/uploads/2020/10/Apple-Iphone-12-Pro-Max-1-600x600.jpg.webp',
    'rate' => '0',
    'brand' => 'Apple',
    'price' => 'JOD 973.00',
    'is_out_of_stock' => '1'
    ...
    [ 
     ...
     'img_url' =>'https://mobizil.com/wp-content/uploads/2020/08/Samsung-Galaxy-Note-20-Ultra.jpg',
    ...
    [ 
     'name' => 'Galaxy A52',
     'img_url' =>'https://mobzel.com/wp-content/uploads/2020/12/samsung-galaxy-a52-specs.jpg',
    'rate' => '0',
    'brand' => 'Samsung',
    'price' => 'JOD 267.00'
    ],
...
<div class="card col-3   mt-2">
  ...
  <div class="card-body">
    ...
    <h2 class="card-title"><?php echo $phones[$i]['name']?></h2>
...
echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-star-fill" viewBox="0 0 16 16">
  ...
  echo'<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-star-fill" viewBox="0 0 16 16">
    ...
    <a href="#"  style="width:150px ;height: 40px;color:gray;">View Details</a>
        <i class="material-icons" style="font-size:25px">chevron_right</i>
        <hr style="color:gainsboro;">
        <h3 style="color:orange;font-weight: bold ;"><?php echo $phones[$i]['price']; ?></h3>
        <a href="#" class="btn btn-dark"style="width:250px ;height: 40px;">Buy now</a>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-icon btn-secondary" style="width:50px ;height: 40px;">
